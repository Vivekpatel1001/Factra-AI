    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/85 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="secondary" className="hidden px-4 sm:inline-flex" onClick={() => navigate("/signup")}>
            {t("signup")}
          </Button>
      ...
      {open && (
        <div className="border-t border-border bg-card px-4 py-4 lg:hidden">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            <Button variant="ghost" onClick={() => { setOpen(false); navigate("/login") }}>
              {t("login")}
            </Button>
            <Button variant="secondary" onClick={() => { setOpen(false); navigate("/signup") }}>
              {t("signup")}
            </Button>
          </div>
        </div>
